...
## TODO - MOVE THIS TO poputils AND MAKE USER-VISIBLE
...
#' agencies to confidentialize data. A value
#' \eqn{n} is rounded as follows:
#'
...
#'
#' @param x A vector of integers. Can be an
#' [rvec][rvec::rvec()].
#'
