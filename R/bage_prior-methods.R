...
make_matrix_effectfree_effect.bage_prior_spline <- function(prior,
  ...
  m_along_by_effect <- make_matrix_along_by_effect(along = along,
                                                   ...
                                                   var_time = var_time,
                                                   var_age = var_age)
  m_along_by_effectfree <- make_matrix_along_by_effectfree(prior = prior,
                                                           dimnames_term = dimnames_term,
                                                           var_time = var_time,
                                                           var_age = var_age,
                                                           var_sexgender = var_sexgender)
  ...
  if (!is_along_first) {
    m_standard_to_alongfirst <- make_matrix_along_first(m_along_by_effectfree)
...
make_matrix_effectfree_effect.bage_prior_svd <- function(prior,
                                                         ...
                                                         var_age,
                                                         var_sexgender) {
  make_matrix_expand_svd(prior = prior,
                         dimnames_term = dimnames_term,
                         var_time = var_time,
                         var_age = var_age,
                         var_sexgender = var_sexgender)
...
make_matrix_effectfree_effect.bage_prior_svd_ar <- function(prior,
                                                            ...
                                                            var_age,
                                                            var_sexgender) {
  make_matrix_effectfree_effect_svd_dynamic(prior = prior,
                                            dimnames_term = dimnames_term,
                                            var_time = var_time,
                                            var_age = var_age,
                                            var_sexgender = var_sexgender)
