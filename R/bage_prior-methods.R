...
#' - [augment()], [components()] Draw from posterior or prior
...
## HAS_TESTS
#' @export
has_hyperrandfree.bage_prior_rwseasfix <- function(prior) TRUE

## HAS_TESTS
#' @export
has_hyperrandfree.bage_prior_rwseasvary <- function(prior) TRUE

## HAS_TESTS
#' @export
has_hyperrandfree.bage_prior_rw2seasfix <- function(prior) TRUE

## HAS_TESTS
#' @export
has_hyperrandfree.bage_prior_rw2seasvary <- function(prior) TRUE
...
## HAS_TESTS
#' @export
make_hyperrand_one.bage_prior_rwseasfix <- function(prior,
                                                    hyperrandfree,
                                                    effectfree,
                                                    dimnames_term,
                                                    var_time,
...
## HAS_TESTS
#' @export
make_hyperrand_one.bage_prior_rwseasvary <- function(prior,
                                                     hyperrandfree,
                                                     effectfree,
                                                     dimnames_term,
                                                     var_time,
...
## HAS_TESTS
#' @export
make_hyperrand_one.bage_prior_rw2seasfix <- function(prior,
                               hyperrandfree,
                               effectfree,
                               dimnames_term,
                               var_time,
...
## HAS_TESTS
#' @export
make_hyperrand_one.bage_prior_rw2seasvary <- function(prior,
                                                      hyperrandfree,
                                                      effectfree,
                                                      dimnames_term,
                                                      var_time,
...
## HAS_TESTS
#' @export
make_i_along.bage_prior_rw <- function(prior, dimnames_term, var_time, var_age) {
  along <- prior$specific$along
  make_i_along_inner(along = along,
                     dimnames_term = dimnames_term,
                     var_time = var_time,
...
## HAS_TESTS
#' @export
make_i_along.bage_prior_rwseasfix <- function(prior, dimnames_term, var_time, var_age) {
  along <- prior$specific$along
  make_i_along_inner(along = along,
                     dimnames_term = dimnames_term,
                     var_time = var_time,
...
## HAS_TESTS
#' @export
make_i_along.bage_prior_rwseasvary <- function(prior, dimnames_term, var_time, var_age) {
  along <- prior$specific$along
  make_i_along_inner(along = along,
                     dimnames_term = dimnames_term,
                     var_time = var_time,
...
## HAS_TESTS
#' @export
make_i_along.bage_prior_rw2 <- function(prior, dimnames_term, var_time, var_age) {
  along <- prior$specific$along
  make_i_along_inner(along = along,
                     dimnames_term = dimnames_term,
                     var_time = var_time,
...
## HAS_TESTS
#' @export
make_i_along.bage_prior_rw2seasfix <- function(prior, dimnames_term, var_time, var_age) {
  along <- prior$specific$along
  make_i_along_inner(along = along,
                     dimnames_term = dimnames_term,
                     var_time = var_time,
...
## HAS_TESTS
#' @export
make_i_along.bage_prior_rw2seasvary <- function(prior, dimnames_term, var_time, var_age) {
  along <- prior$specific$along
  make_i_along_inner(along = along,
                     dimnames_term = dimnames_term,
                     var_time = var_time,
...
## HAS_TESTS
#' @export
make_i_along.bage_prior_svd_rw <- function(prior, dimnames_term, var_time, var_age) {
  make_i_along_agetime(prior = prior,
                       dimnames_term = dimnames_term,
                       var_time = var_time,
                       var_age = var_age,
...
## HAS_TESTS
#' @export
make_i_along.bage_prior_svd_rw2 <- function(prior, dimnames_term, var_time, var_age) {
  make_i_along_agetime(prior = prior,
                       dimnames_term = dimnames_term,
                       var_time = var_time,
                       var_age = var_age,
...
## HAS_TESTS
#' @export
length_hyperrandfree.bage_prior_rwseasfix <- function(prior,
                                                      dimnames_term,
                                                      var_time,
                                                      var_age,
                                                      var_sexgender) {
...
## HAS_TESTS
#' @export
length_hyperrandfree.bage_prior_rwseasvary <- function(prior,
                                                   dimnames_term,
                                                   var_time,
                                                   var_age,
                                 var_sexgender) {
...
## HAS_TESTS
#' @export
length_hyperrandfree.bage_prior_rw2seasfix <- function(prior,
                                                       dimnames_term,
                                                       var_time,
                                                       var_age,
                                                       var_sexgender) {
...
## HAS_TESTS
#' @export
length_hyperrandfree.bage_prior_rw2seasvary <- function(prior,
                                                        dimnames_term,
                                                        var_time,
                                                        var_age,
                                                        var_sexgender) {
...
## HAS_TESTS
#' @export
levels_hyperrand.bage_prior_rwseasfix <- function(prior, dimnames_term, var_age, var_time) {
  levels <- dimnames_to_levels(dimnames_term)
  c(levels, levels)
}
...
## HAS_TESTS
#' @export
levels_hyperrand.bage_prior_rwseasvary <- function(prior, dimnames_term, var_age, var_time) {
  levels <- dimnames_to_levels(dimnames_term)
  c(levels, levels)
}
...
## HAS_TESTS
#' @export
levels_hyperrand.bage_prior_rw2seasfix <- function(prior, dimnames_term, var_age, var_time) {
  levels <- dimnames_to_levels(dimnames_term)
  c(levels, levels)
}
...
## HAS_TESTS
#' @export
levels_hyperrand.bage_prior_rw2seasvary <- function(prior, dimnames_term, var_age, var_time) {
  levels <- dimnames_to_levels(dimnames_term)
  c(levels, levels)
}
...
## HAS_TESTS
#' @export
make_matrix_along_by_effectfree_innermost.bage_prior_svd_rw <- function(prior, 
                                                                        dimnames_term,
                                                                        var_time,
                                                                        var_age,
                                                                        var_sexgender,
...
## HAS_TESTS
#' @export
make_matrix_along_by_effectfree_innermost.bage_prior_svd_rw2 <- function(prior, 
                                                                         dimnames_term,
                                                                         var_time,
                                                                         var_age,
                                                                         var_sexgender,
...
## HAS_TESTS
#' @export
make_matrix_effectfree_effect.bage_prior_rwseasfix <- function(prior,
                                                               dimnames_term,
                                                               var_time,
                                                               var_age,
                                                               var_sexgender) {
...
## HAS_TESTS
#' @export
make_matrix_effectfree_effect.bage_prior_rwseasvary <- function(prior,
                                                                dimnames_term,
                                                                var_time,
                                                                var_age,
                                                                var_sexgender) {
...
## HAS_TESTS
#' @export
make_matrix_effectfree_effect.bage_prior_rw2seasfix <- function(prior,
                                                               dimnames_term,
                                                               var_time,
                                                               var_age,
                                                               var_sexgender) {
...
## HAS_TESTS
#' @export
make_matrix_effectfree_effect.bage_prior_rw2seasvary <- function(prior,
                                                                dimnames_term,
                                                                var_time,
                                                                var_age,
                                                                var_sexgender) {
...
## HAS_TESTS
#' @export
uses_hyperrandfree.bage_prior_rwseasfix <- function(prior) TRUE

## HAS_TESTS
#' @export
uses_hyperrandfree.bage_prior_rwseasvary <- function(prior) TRUE

## HAS_TESTS
#' @export
uses_hyperrandfree.bage_prior_rw2seasfix <- function(prior) TRUE

## HAS_TESTS
#' @export
uses_hyperrandfree.bage_prior_rw2seasvary <- function(prior) TRUE
...
## HAS_TESTS
#' @export
uses_matrix_effectfree_effect.bage_prior_rwseasfix <- function(prior) TRUE

## HAS_TESTS
#' @export
uses_matrix_effectfree_effect.bage_prior_rwseasvary <- function(prior) TRUE

## HAS_TESTS
#' @export
uses_matrix_effectfree_effect.bage_prior_rw2 <- function(prior) TRUE
...
## HAS_TESTS
#' @export
uses_matrix_effectfree_effect.bage_prior_rw2seasfix <- function(prior) TRUE

## HAS_TESTS
#' @export
uses_matrix_effectfree_effect.bage_prior_rw2seasvary <- function(prior) TRUE
