...
#' |-----------|--------------------------|------------------------------|------|
#' | [N()]     | Elements drawn from a common normal distribution with mean 0 and standard devation estimated from the data. | Main effects or interactions with no natural order or neighborbood structure. | Yes |
...
#' | [RW()]    | Random walk. Elements have a natural ordering, and neighboring elements more strongly correlated than distant elements. | Modelling age, time, cohort, or other smoothly-varying dimensions. | Yes |
...
#' | [SVD_RW()] | Like `SVD()`, but coefficients evolve over time, following random walk models. | Interactions between age, time, possibly sex/gender, and possibly other variables. | Yes |
