...
#' | [RWSeas()] | Random walk, with seasonal effect. | Main effects or interactions involving time. | Yes |
#' | [RW2Seas()] | Random walk with drift, with seasonal effect. | Main effects or interactions involving time. | Yes |
