...
#>        0.67     0.27      0.32   11      TRUE   relative convergence (4)
```
...
#>  2 0.000171    7.8e-05 (5.6e-05, 1e-04) 7.4e-05 (6.2e-05, 9.1e-05)
#>  3 0.0000914   1e-04 (7.3e-05, 0.00013)   1e-04 (8.5e-05, 0.00012)
#>  4 0.000221  0.00041 (0.00031, 0.00052)   0.00045 (4e-04, 0.00051)
#>  5 0.000246  0.00038 (0.00029, 0.00049)   4e-04 (0.00036, 0.00046)
#>  6 0.000248  0.00035 (0.00027, 0.00045) 0.00037 (0.00033, 0.00042)
#>  7 0.000532    0.00038 (3e-04, 0.00049) 0.00036 (0.00032, 0.00041)
#>  8 0.000135  0.00031 (0.00023, 0.00041)   0.00034 (3e-04, 0.00038)
#>  9 0.000331  0.00033 (0.00026, 0.00043) 0.00033 (0.00029, 0.00038)
#> 10 0.000436    0.00031 (0.00023, 4e-04) 0.00031 (0.00027, 0.00035)
#> # ℹ 902 more rows
```
...
#>  1 (Intercept) effect    (Intercept) -1.7 (-3.6, -0.012)
#>  2 age         effect    0-4           -1.6 (-3.6, 0.04)
#>  3 age         effect    5-9           -2.9 (-4.9, -1.1)
#>  4 age         effect    10-14        -2.4 (-4.4, -0.69)
#>  5 age         effect    15-19           -0.79 (-2.8, 1)
#>  6 age         effect    20-24         -0.69 (-2.6, 1.1)
#>  7 age         effect    25-29        -0.81 (-2.8, 0.95)
#>  8 age         effect    30-34        -0.86 (-2.9, 0.88)
#>  9 age         effect    35-39        -0.89 (-2.9, 0.97)
#> 10 age         effect    40-44        -0.89 (-2.9, 0.96)
#> # ℹ 79 more rows
```
...
#>  1 0-4    -1.6 (-3.6, 0.04)
#>  2 5-9    -2.9 (-4.9, -1.1)
#>  3 10-14 -2.4 (-4.4, -0.69)
#>  4 15-19    -0.79 (-2.8, 1)
#>  5 20-24  -0.69 (-2.6, 1.1)
#>  6 25-29 -0.81 (-2.8, 0.95)
#>  7 30-34 -0.86 (-2.9, 0.88)
#>  8 35-39 -0.89 (-2.9, 0.97)
#>  9 40-44 -0.89 (-2.9, 0.96)
#> 10 45-49   -0.96 (-3, 0.87)
#> 11 50-54 -0.91 (-2.9, 0.95)
#> 12 55-59   -0.92 (-3, 0.95)
```
...
#>  1 0.00022 (0.00017, 0.00029)     0.000169    0.000224      0.000291 
#>  2 5.7e-05 (4.1e-05, 8.1e-05)     0.0000413   0.0000573     0.0000806
#>  3 8.7e-05 (6.5e-05, 0.00012)     0.0000645   0.0000866     0.000117 
#>  4 0.00036 (0.00027, 0.00046)     0.000274    0.000361      0.000459 
#>  5 0.00035 (0.00027, 0.00044)     0.000270    0.000346      0.000439 
#>  6 0.00032 (0.00024, 0.00041)     0.000244    0.000322      0.000411 
#>  7 0.00034 (0.00026, 0.00044)     0.000260    0.000336      0.000437 
#>  8 0.00027 (0.00021, 0.00036)     0.000210    0.000275      0.000357 
#>  9 0.00028 (0.00021, 0.00037)     0.000213    0.000281      0.000368 
#> 10   0.00024 (0.00018, 3e-04)     0.000180    0.000237      0.000304 
#> # ℹ 38 more rows
```
...
#> 
#>  time_total time_max time_draw iter converged                    message
#>        2.00     1.14      0.76   22      TRUE   relative convergence (4)
```
...
#>    term  component level              .fitted
#>    <chr> <chr>     <chr>         <rdbl<1000>>
#>  1 year  effect    2019  -0.088 (-0.38, 0.18)
#>  2 year  effect    2020   -0.081 (-0.4, 0.26)
#>  3 year  effect    2021  -0.072 (-0.46, 0.31)
#>  4 year  effect    2022  -0.072 (-0.48, 0.33)
#>  5 year  effect    2023   -0.06 (-0.48, 0.38)
#>  6 year  effect    2024   -0.059 (-0.5, 0.38)
#>  7 year  effect    2025   -0.045 (-0.54, 0.4)
#>  8 year  effect    2026   -0.039 (-0.58, 0.4)
#>  9 year  effect    2027   -0.032 (-0.59, 0.4)
#> 10 year  effect    2028   -0.02 (-0.57, 0.45)
```
