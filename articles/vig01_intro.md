...
#>        0.84     0.35      0.41   11      TRUE   relative convergence (4)
```
...
#>  2 0.000171    7.8e-05 (5.7e-05, 1e-04) 7.5e-05 (6.1e-05, 9.2e-05)
#>  3 0.0000914   1e-04 (7.5e-05, 0.00014)   1e-04 (8.7e-05, 0.00012)
#>  4 0.000221  0.00041 (0.00031, 0.00052)     0.00045 (4e-04, 5e-04)
#>  5 0.000246    0.00038 (3e-04, 0.00049)   4e-04 (0.00036, 0.00045)
#>  6 0.000248  0.00035 (0.00026, 0.00044) 0.00037 (0.00032, 0.00041)
#>  7 0.000532  0.00038 (0.00029, 0.00049) 0.00036 (0.00032, 0.00041)
#>  8 0.000135  0.00031 (0.00023, 0.00041)   0.00034 (3e-04, 0.00039)
#>  9 0.000331  0.00033 (0.00025, 0.00044) 0.00033 (0.00029, 0.00038)
#> 10 0.000436    0.00031 (0.00023, 4e-04)   3e-04 (0.00026, 0.00035)
#> # ℹ 902 more rows
```
...
#>  1 (Intercept) effect    (Intercept) -1.7 (-3.5, 0.048)
#>  2 age         effect    0-4          -1.7 (-3.4, 0.14)
#>  3 age         effect    5-9            -3 (-4.6, -1.1)
#>  4 age         effect    10-14        -2.5 (-4.3, -0.7)
#>  5 age         effect    15-19       -0.91 (-2.6, 0.97)
#>  6 age         effect    20-24        -0.79 (-2.6, 1.1)
#>  7 age         effect    25-29        -0.9 (-2.7, 0.94)
#>  8 age         effect    30-34       -0.99 (-2.8, 0.92)
#>  9 age         effect    35-39       -0.97 (-2.8, 0.92)
#> 10 age         effect    40-44       -0.99 (-2.8, 0.95)
#> # ℹ 79 more rows
```
...
#>  2 5-9      -3 (-4.6, -1.1)
#>  3 10-14  -2.5 (-4.3, -0.7)
#>  4 15-19 -0.91 (-2.6, 0.97)
#>  5 20-24  -0.79 (-2.6, 1.1)
#>  6 25-29  -0.9 (-2.7, 0.94)
#>  7 30-34 -0.99 (-2.8, 0.92)
#>  8 35-39 -0.97 (-2.8, 0.92)
#>  9 40-44 -0.99 (-2.8, 0.95)
#> 10 45-49    -1 (-2.9, 0.92)
#> 11 50-54 -0.99 (-2.8, 0.98)
#> 12 55-59 -0.99 (-2.8, 0.99)
```
...
#>  1 0.00023 (0.00017, 0.00029)     0.000172    0.000226      0.000289 
#>  2 5.8e-05 (4.2e-05, 8.2e-05)     0.0000416   0.0000580     0.0000823
#>  3 8.7e-05 (6.6e-05, 0.00012)     0.0000656   0.0000873     0.000116 
#>  4 0.00036 (0.00027, 0.00046)     0.000275    0.000361      0.000457 
#>  5 0.00035 (0.00027, 0.00044)     0.000274    0.000346      0.000438 
#>  6 0.00032 (0.00025, 0.00041)     0.000245    0.000320      0.000408 
#>  7 0.00034 (0.00026, 0.00044)     0.000257    0.000338      0.000440 
#>  8 0.00028 (0.00021, 0.00035)     0.000210    0.000275      0.000354 
#>  9 0.00028 (0.00021, 0.00037)     0.000214    0.000281      0.000370 
#> 10 0.00024 (0.00018, 0.00031)     0.000179    0.000237      0.000305 
#> # ℹ 38 more rows
```
...
#> 
#>  time_total time_max time_draw iter converged                    message
#>        2.77     1.61      1.04   22      TRUE   relative convergence (4)
```
...
#>    term  component level              .fitted
#>    <chr> <chr>     <chr>         <rdbl<1000>>
#>  1 year  effect    2019  -0.087 (-0.35, 0.16)
#>  2 year  effect    2020  -0.075 (-0.39, 0.27)
#>  3 year  effect    2021   -0.072 (-0.46, 0.3)
#>  4 year  effect    2022  -0.075 (-0.49, 0.33)
#>  5 year  effect    2023  -0.056 (-0.49, 0.37)
#>  6 year  effect    2024  -0.062 (-0.51, 0.39)
#>  7 year  effect    2025   -0.05 (-0.54, 0.39)
#>  8 year  effect    2026  -0.041 (-0.57, 0.41)
#>  9 year  effect    2027   -0.03 (-0.59, 0.44)
#> 10 year  effect    2028  -0.024 (-0.58, 0.44)
```
...
#>  1 0-4   Female Maori      2010       NA   12 (5, 21) 43440        NA
#>  2 5-9   Female Maori      2010       NA     3 (0, 7) 36340        NA
#>  3 10-14 Female Maori      2010       NA     3 (0, 8) 35520        NA
#>  4 15-19 Female Maori      2010       NA   14 (7, 24) 34960        NA
#>  5 20-24 Female Maori      2010       NA   12 (5, 21) 31060        NA
#>  6 25-29 Female Maori      2010       NA    8 (3, 15) 24000        NA
#>  7 30-34 Female Maori      2010       NA    8 (3, 15) 23180        NA
#>  8 35-39 Female Maori      2010       NA    7 (3, 14) 24260        NA
...
We are grateful for any bug reports or suggestions for features. The
