...
#>        1.15     0.63      0.44   30      TRUE   relative convergence (4)
```
...
#> 2 covariates coef      dens_2020Medium -0.94 (-2.5, 0.69)
```
...
#> 
#>  time_total time_max time_draw iter converged                    message
#>        0.83     0.41      0.38   22      TRUE   relative convergence (4)
```
...
#>   age                .fitted
#>   <chr>         <rdbl<1000>>
#> 1 10-14   0.58 (-0.031, 1.3)
#> 2 15-19 -0.0093 (-0.22, 0.2)
#> 3 20-24  0.045 (-0.15, 0.24)
#> 4 25-29  0.062 (-0.12, 0.25)
#> 5 30-34   0.079 (-0.1, 0.26)
#> 6 35-39  0.048 (-0.15, 0.22)
#> 7 40-44  0.072 (-0.11, 0.26)
#> 8 45-49  0.095 (-0.17, 0.37)
#> 9 50-54   0.33 (-0.25, 0.86)
```
