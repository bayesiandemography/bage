...
cmd_assign(.injuries_raw = "injuries/TABLECODE7935_Data.csv.gz",
           .popn_maori_raw = "injuries/DPE479901_20230101_021445_73.csv.gz",
           .popn_total_raw = "injuries/DPE403903_20230101_021709_80.csv.gz",
           .out = "../data/injuries.rda")
