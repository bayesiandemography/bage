...
#>  1 (Intercept) effect    (Intercept) -4.3 (-5.7, -2.8)
#>  2 age         effect    0-4         -4.2 (-5.6, -2.8)
#>  3 age         effect    5-9           -5.6 (-7, -4.1)
#>  4 age         effect    10-14       -5.1 (-6.5, -3.6)
#>  5 age         effect    15-19       -3.4 (-4.8, -1.9)
#>  6 age         effect    20-24       -3.2 (-4.6, -1.8)
#>  7 age         effect    25-29       -3.3 (-4.7, -1.8)
#>  8 age         effect    30-34       -3.3 (-4.8, -1.9)
#>  9 age         effect    35-39         -3.4 (-4.8, -2)
#> 10 age         effect    40-44         -3.4 (-4.8, -2)
#> 11 age         effect    45-49         -3.5 (-5, -2.1)
#> 12 age         effect    50-54       -3.5 (-4.9, -2.1)
#> 13 age         effect    55-59       -3.5 (-4.9, -2.1)
#> 14 age         hyper     sd            0.7 (0.46, 1.1)
#> 15 disp        disp      disp         0.4 (0.36, 0.44)
...
#>    term        component level                 .fitted
#>    <chr>       <chr>     <chr>            <rdbl<1000>>
#>  1 (Intercept) effect    (Intercept) -4.2 (-5.6, -2.8)
#>  2 age         effect    0-4         -4.2 (-5.7, -2.8)
#>  3 age         effect    5-9           -5.6 (-7, -4.2)
#>  4 age         effect    10-14       -5.1 (-6.5, -3.7)
#>  5 age         effect    15-19         -3.4 (-4.8, -2)
#>  6 age         effect    20-24       -3.2 (-4.6, -1.8)
#>  7 age         effect    25-29       -3.3 (-4.7, -1.9)
#>  8 age         effect    30-34       -3.3 (-4.7, -1.9)
#>  9 age         effect    35-39         -3.4 (-4.9, -2)
#> 10 age         effect    40-44         -3.4 (-4.9, -2)
#> 11 age         effect    45-49       -3.5 (-4.9, -2.1)
#> 12 age         effect    50-54         -3.5 (-4.9, -2)
#> 13 age         effect    55-59       -3.5 (-4.9, -2.1)
#> 14 age         hyper     sd           0.72 (0.47, 1.1)
#> 15 disp        disp      disp         0.4 (0.36, 0.44)
```
