...
### Derivation of $u_i \mid y_i^{\text{obs}}, \pi_{g[i]}, \kappa_{h[i]}, \mu_i, \xi, w_i$ in Section \@ref(sec:datamod-pois-out)
...
\begin{align}
  ...
  v_i & \sim \text{Poisson}(\kappa_{h[i]} \gamma_i w_i).
\end{align}
with $y_i^{\text{obs}} = u_i + v_i$, implying that,
\begin{align}
...
We then have
\begin{align}
  p(u_i \mid y_i^{\text{obs}}, \mu_i, \xi, \pi_{g[i]}, \kappa_{h[i]}, w_i) & = \int_0^{\infty} p(u_i \mid y_i^{\text{obs}}, \gamma_i, \pi_{g[i]}, \kappa_{h[i]}, w_i) p(\gamma_i \mid y_i^{\text{obs}}, \mu_i, \xi \pi_{g[i]}, \kappa_{h[i]}, w_i) \, \text{d}\gamma_i \\
  & = \int_0^{\infty} \text{Binomial}\left(u_i \,\middle|\, y_i^{\text{obs}}, \frac{\pi_{g[i]}}{\pi_{g[i]} + \kappa_{h[i]}} \right) p(\gamma_i \mid \mu_i, \xi) \, \text{d}\gamma_i \\
  & = \text{Binomial}\left(u_i \,\middle|\, y_i^{\text{obs}}, \frac{\pi_{g[i]}}{\pi_{g[i]} + \kappa_{h[i]}} \right) \int_0^{\infty}  p(\gamma_i \mid \mu_i, \xi) \, \text{d}\gamma_i \\
  & = \text{Binomial}\left(u_i \,\middle|\, y_i^{\text{obs}}, \frac{\pi_{g[i]}}{\pi_{g[i]} + \kappa_{h[i]}} \right)
\end{align}



### Derivation of $y_i^{\text{true}} \mid u_i, \pi_{g[i]}, \kappa_{h[i]}, \mu_i, w_i, \xi$ in Section \@ref(sec:datamod-pois-out)
...
### Derivation of $p(w_i^{\text{true}} \mid w_i^{\text{obs}})$
