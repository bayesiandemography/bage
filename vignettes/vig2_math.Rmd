...
```
RW(s = 1, along = NULL, con = c("none", "by"))
```
...
```
RW_Seas(n_seas, s = 1, sd = 1, s_seas = 0, sd_seas = 1, along = NULL, con = c("none", "by"))
```
...
```
RW2_Seas(n_seas, s = 1, sd = 1, sd_slope = 1, s_seas = 0, sd_seas = 1, along = NULL, con = c("none", "by"))
```
...
```
Lin(s = 1, mean_slop = 0, sd_slope = 1, along = NULL, con = c("none", "by"))
```
