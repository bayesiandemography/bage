...
Let $y_i$ be the outcome, and $w_i$ a weight, for cell $i$. We set
\begin{align}
  \bar{y} & = \frac{\sum_{i=1}^n y_i}{n} \\
  s & = \sqrt{\frac{\sum_{i=1}^n (y_i - \bar{y})^2}{n-1}} \\
  \bar{w} & = \frac{\sum_{i=1}^n w_i}{n}
\end{align}
and obtained standardized versions of $y_i$ and $w_i$
\begin{align}
