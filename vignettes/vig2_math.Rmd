...
- `indep` determines whether and indepenent or joint model will be used if the term being modelled contains a sex or gender variable.
...
The `SVD_RW()` prior is identical to the `SVD()` prior except that the coefficients evolve over time, following indepenent random walks. For instance, in the combined-sex/gender and joint models,
